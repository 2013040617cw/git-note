...
本地版本控制就是把版本信息放在你的自己的电脑里，可以对每一个版本做一个[快照](https://so.csdn.net/so/search?q=快照&spm=1001.2101.3001.7020)，要使用的时候，在你自己计算机上获取就可以了
...
不会因为服务器损坏或者网络问题，造成不能工作的情况！ 这就能使3台主机的内容保持一致。
...
![image-20220706113329929](心碎的莫扎特聊Git.assets/image-20220706113329929.png)
...
```
git config --global user.name "cuiwei"        #名称
git config --global user.email 705040525@qq.com   #邮箱
```
...
![image-20220706155925089](心碎的莫扎特聊Git.assets/image-20220706155925089.png)



2、执行后可以看到，仅仅在项目目录多出了一个.git目录，关于版本等的所有信息都在这个目录里面。

![image-20220706160136902](心碎的莫扎特聊Git.assets/image-20220706160136902.png)
